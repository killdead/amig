            ...
            switch ( $step ) {
                ...
                case Steps::REPEAT:
                    ...
                    if ( $step == Steps::REPEAT ) {
                        ...
                        $service_dp           = Lib\Slots\DatePoint::fromStr( $slots[0][2] )->toWpTz();
                ...
                default:
                    ...
                    foreach ( $userData->cart->getItems() as $item => $cart_item ) {
                    ...
                    $info_text_codes = array(
                        ...
                        '{service_time}'       => '<b> TEST' . implode( ', ', $data['service_time'] ) . '</b>',
                        '{staff_info}'         => '<b>' . implode( ', ', $data['staff_info'] ) . '</b>',
